...
export interface ApiIsOpenIsOpen extends Schema.SingleType {
  collectionName: 'is_opens';
  info: {
    singularName: 'is-open';
    pluralName: 'is-opens';
    displayName: 'isOpen';
    description: '';
  };
...
export interface ApiVoteVote extends Schema.CollectionType {
  ...
  attributes: {
    glos: Attribute.Enumeration<['TAK', 'NIE', 'WSTRZYMUJE']> &
      Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::is-open.is-open': ApiIsOpenIsOpen;
